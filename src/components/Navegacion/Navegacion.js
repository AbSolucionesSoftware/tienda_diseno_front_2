...
const Navegacion = (props) => {
	const { loading, datosContx } = useContext(MenuContext);
							...
							<div className="col-lg-12 container-pages a4">
								...
								>
									...
									{datosContx.tienda && datosContx.tienda.length > 0 ? (
										<Menu.Item
											className="nav-font-color nav-border-color font-nav-sec a6"
											key="/quienes_somos"
										>
						...
						<div className="top-menu row a3">
							...
							<div className="col-lg-5 row a4 containe-categorias d-flex justify-content-end">
								...
								>
									...
									{datosContx.ofertas ? (
										<Menu.Item
											className="nav-font-color nav-border-color font-nav a6"
											key="/ofertas"
										>
